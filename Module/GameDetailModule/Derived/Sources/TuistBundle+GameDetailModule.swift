...
/// Since GameDetailModule is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "GameDetailModule_GameDetailModule"
    var candidates = [
    ...
    fatalError("unable to find bundle named GameDetailModule_GameDetailModule")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class GameDetailModuleResources: NSObject {
