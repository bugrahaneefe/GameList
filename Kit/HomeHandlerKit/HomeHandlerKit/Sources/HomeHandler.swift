...
extension HomeHandler: HomeHandlerInterface {
    public func gameListDetails(at page: Int, completion: @escaping (GameListDetailsResult) -> Void) {
        interactor.gameListDetails(at: page) { [weak self] (result: Result<GameListDetailsResponse, Error>) in
